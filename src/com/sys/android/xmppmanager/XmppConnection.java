...
public class XmppConnection {
	...
	public static int    SERVER_PORT = 5220;//服务端口 可以在openfire上设置
	public static String SERVER_HOST = "129.128.184.46";//你openfire服务器所在的ip
	public static  String SERVER_NAME = "myria";//设置openfire时的服务器名
